...
- [What is Amazon Web Services?](#what-is-amazon-web-services)
  - [What is Amazon Web Services (AWS)?](#what-is-amazon-web-services-aws)
    - [Figure 1.1 Ka Breakdown (AWS data center locations)](#figure-1-1-ka-breakdown-aws-data-center-locations)
  - [What can you do with AWS?](#what-can-you-do-with-aws)
  - [Hosting a web shop](#hosting-a-web-shop)
    - [Figure 1.2 Ka Breakdown (Running a web shop on-premises vs. on AWS)](#figure-1-2-ka-breakdown-running-a-web-shop-on-premises-vs-on-aws)
    - [Figure 1.3 Ka Breakdown (Enhanced Web Shop Setup)](#figure-1-3-ka-breakdown-enhanced-web-shop-setup)
  - [Running a Java EE application in your private network](#running-a-java-ee-application-in-your-private-network)
    - [Security Aur Traffic Ka Control](#security-aur-traffic-ka-control)
    - [Figure 1.4 Ka Breakdown (Running a Java EE application with enterprise networking)](#figure-1-4-ka-breakdown-running-a-java-ee-application-with-enterprise-networking)
    - [Future Plans Aur Project Ki Kamyabi](#future-plans-aur-project-ki-kamyabi)
  - [Implementing a highly available system](#implementing-a-highly-available-system)
    - [Figure 1.5 Ka Breakdown (Building a highly available system on AWS)](#figure-1-5-ka-breakdown-building-a-highly-available-system-on-aws)
  - [Profiting from low costs for batch processing infrastructure](#profiting-from-low-costs-for-batch-processing-infrastructure)
    - [Nick Ka System Kaise Kaam Karta Hai? (Step-by-Step Flow)](#nick-ka-system-kaise-kaam-karta-hai-step-by-step-flow)
    - [Chota Budget Aur AWS Ka Clever Pricing Model](#chota-budget-aur-aws-ka-clever-pricing-model)
    - [Figure 1.6 Ka Breakdown (Pay-per-use price model)](#figure-1-6-ka-breakdown-pay-per-use-price-model)
  - [How you can benefit from using AWS](#how-you-can-benefit-from-using-aws)
    - [Innovative and fast-growing platform](#innovative-and-fast-growing-platform)
    - [Services solve common problems](#services-solve-common-problems)
    - [Enabling automation](#enabling-automation)
    - [Flexible capacity (scalability)](#flexible-capacity-scalability)
    - [Figure 1.7 Ka Breakdown (Seasonal traffic patterns for a web shop)](#figure-1-7-ka-breakdown-seasonal-traffic-patterns-for-a-web-shop)
    - [Built for failure (reliability)](#built-for-failure-reliability)
    - [Reducing time to market](#reducing-time-to-market)
    - [Benefiting from economies of scale](#benefiting-from-economies-of-scale)
    - [Global infrastructure](#global-infrastructure)
    - [Professional partner](#professional-partner)
  - [How much does it cost?](#how-much-does-it-cost)
    - [Free Tier](#free-tier)
    - [Billing example](#billing-example)
      - [Figure 1.8 Ka Breakdown (Some services are billed based on time of use, others by throughput or consumed storage)](#figure-1-8-ka-breakdown-some-services-are-billed-based-on-time-of-use-others-by-throughput-or-consumed-storage)
      - [Table 1.1 Ka Breakdown (How an AWS bill changes if the number of web shop visitors increases)](#table-1-1-ka-breakdown-how-an-aws-bill-changes-if-the-number-of-web-shop-visitors-increases)
    - [Pay-per-use opportunities](#pay-per-use-opportunities)
    - [Comparing alternatives](#comparing-alternatives)
      - [Magar in cloud providers mein aakhir Faraq kya hai?](#magar-in-cloud-providers-mein-aakhir-faraq-kya-hai)
  - [Exploring AWS services](#exploring-aws-services)
    - [Figure 1.9 Ka Breakdown (The AWS cloud is composed of hardware and software services accessible via an API)](#figure-1-9-ka-breakdown-the-aws-cloud-is-composed-of-hardware-and-software-services-accessible-via-an-api)
    - [Figure 1.10 Ka Breakdown (Managing a custom application running on a virtual machine and cloud-native services)](#figure-1-10-ka-breakdown-managing-a-custom-application-running-on-a-virtual-machine-and-cloud-native-services)
    - [Figure 1.11 Ka Breakdown (Handling an HTTP request with a custom web application using additional AWS services)](#figure-1-11-ka-breakdown-handling-an-http-request-with-a-custom-web-application-using-additional-aws-services)
    - [Services Ki Bharmaar Aur Categories](#services-ki-bharmaar-aur-categories)
    - [Kitab Ka Scope (Selected Must-Have Services)](#kitab-ka-scope-selected-must-have-services)
  - [Interacting with AWS](#interacting-with-aws)
    - [Figure 1.12 Ka Breakdown (Different ways to access the AWS API)](#figure-1-12-ka-breakdown-different-ways-to-access-the-aws-api)
    - [Management Console](#management-console)
      - [Figure 1.13 Ka Breakdown (The AWS Management Console GUI)](#figure-1-13-ka-breakdown-the-aws-management-console-gui)
    - [Command-line interface](#command-line-interface)
      - [Figure 1.14 Ka Breakdown (The CLI in action)](#figure-1-14-ka-breakdown-the-cli-in-action)
    - [SDKs](#sdks)
    - [Blueprints](#blueprints)
      - [Figure 1.15 Ka Breakdown (Infrastructure automation with blueprints)](#figure-1-15-ka-breakdown-infrastructure-automation-with-blueprints)
      - [Barray Networks Ka Trade-off Decision (Custom Code vs Blueprints)](#barray-networks-ka-trade-off-decision-custom-code-vs-blueprints)
    - [Comparisons](#comparisons)
  - [Creating an AWS account](#creating-an-aws-account)
  - [Signing up](#signing-up)
    - [1. PROVIDING LOGIN CREDENTIALS](#1-providing-login-credentials)
      - [Figure 1.16 Ka Breakdown](#figure-1-16-ka-breakdown)
    - [2. PROVIDING CONTACT INFORMATION](#2-providing-contact-information)
      - [Figure 1.17 Ka Breakdown](#figure-1-17-ka-breakdown)
    - [3. PROVIDING PAYMENT DETAILS](#3-providing-payment-details)
      - [Figure 1.18 Ka Breakdown](#figure-1-18-ka-breakdown)
    - [4. VERIFYING YOUR IDENTITY](#4-verifying-your-identity)
      - [Figure 1.19 Ka Breakdown](#figure-1-19-ka-breakdown)
    - [5. CHOOSING A SUPPORT PLAN](#5-choosing-a-support-plan)
      - [Figure 1.20 Ka Breakdown](#figure-1-20-ka-breakdown)
      - [Figure 1.21 Ka Breakdown](#figure-1-21-ka-breakdown)
  - [Signing in](#signing-in)
    - [Figure 1.22 Ka Breakdown](#figure-1-22-ka-breakdown)
    - [Figure 1.23 Ka Breakdown](#figure-1-23-ka-breakdown)
    - [Figure 1.24 Ka Breakdown (AWS Management Console navigation bar)](#figure-1-24-ka-breakdown-aws-management-console-navigation-bar)
  - [Creating a budget alert to keep track of your AWS bill](#creating-a-budget-alert-to-keep-track-of-your-aws-bill)
    - [Free Tier Usage Alert Configuration (Shuruati Setting)](#free-tier-usage-alert-configuration-shuruati-setting)
      - [Figure 1.25 Ka Breakdown (Creating a Free Tier usage alert to avoid unwanted costs)](#figure-1-25-ka-breakdown-creating-a-free-tier-usage-alert-to-avoid-unwanted-costs)
      - [Figure 1.26 Ka Breakdown (Creating a cost budget to monitor incurred and forecasted costs)](#figure-1-26-ka-breakdown-creating-a-cost-budget-to-monitor-incurred-and-forecasted-costs)
      - [Figure 1.27 Ka Breakdown (Setting your budget amount)](#figure-1-27-ka-breakdown-setting-your-budget-amount)
      - [Figure 1.28 Ka Breakdown (Defining alert thresholds)](#figure-1-28-ka-breakdown-defining-alert-thresholds)
...
* **Per-Second Billing:** AWS virtual machines ka bill har aik second ke hisab se banata hai, bashart-e-ke kam az kam bill 60 seconds (aik minute) ka zaroor banta hai. Nick ne is ka faida uthatay huay aik rule banaya: Jaise hi batch job shuru hota hai, woh virtual machine ko **start (launch)** karta hai, aur jaise hey kaam mukammal hota hai, woh machine ko foran **band (terminate)** kar deta hai. Is tarah woh computing infrastructure ke paise sirf ussi waqt ke deta hai jab woh waqai chal rahi hoti hai. Purane zamane ke traditional data centers ke muwazne yeh aik bohot barra badlao (**game changer**) hai, jahan machine chahe farigh baithi rahe ya chale, aap ko har mahine ka poora flat bill dena parta tha.
